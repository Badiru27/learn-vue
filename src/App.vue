<template>
 <div class="container">
  <HomeHeader @show-add-task="showTask" title="Sunshine" :showAddTask="showAddtask"/>
 <div v-show="showAddtask"> <AddTask @add-task ='addTask'/></div>
  <TaskData @toggle-reminder="toggleReminder" @delete-task="deleteTask" 
  :tasks = "tasks"/>
 </div>
</template>
...
export default {
  ...
  const updateTask = {...taskToToggle, reminder: !this.reminder}
